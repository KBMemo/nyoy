...
This package is currently a repository-internal path gem. It contains the graph definition, transition result, state schema, execution runner, and runtime context protocol. Rails persistence and application workflows remain in Nyoy.
